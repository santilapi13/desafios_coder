...
export class ViewsRouter extends Router {
    init() {
        ...
        this.get('/profile', ["USER", "ADMIN", "PREMIUM"], nonAuthenticated, viewsController.getProfile);

        this.get('/products', ["USER", "ADMIN", "PREMIUM"], nonAuthenticated, viewsController.getProducts);

        this.get('/products/:pid', ["USER", "ADMIN", "PREMIUM"], nonAuthenticated, viewsController.getProductById);

        this.get('/carts/:cid', ["USER", "ADMIN", "PREMIUM"],  nonAuthenticated, viewsController.getCartById);
